...
the shell and Core. `/audit status` checks audit health; contextual trace and
export operations follow the current Shell session. In enhanced integration,
the cosh-core runtime makes
...
- [Audit and incident export](../../docs/user-guide/en/user-entrypoint/cosh-ng/shell/audit.md)
