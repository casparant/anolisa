...
function main() {
  ...
  if (!pkgName) {
    ...
    console.warn('You can build from source: https://github.com/alibaba/anolisa/tree/main/providers/tokenless');
    process.exit(0);
  }
  ...
  if (isMusl()) {
    ...
    console.error(
      'Build from source for your libc: https://github.com/alibaba/anolisa/tree/main/providers/tokenless',
    );
    process.exit(1);
  }
  ...
  if (!pkgDir || !existsSync(pkgDir)) {
    ...
    console.error(
      'You can also build from source: https://github.com/alibaba/anolisa/tree/main/providers/tokenless',
    );
