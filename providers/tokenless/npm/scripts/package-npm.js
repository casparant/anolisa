...
function buildAdapters() {
  ...
  try {
    ...
    throw new Error(
      ...
      `Build manually with: make -C providers/tokenless build-openclaw-plugin build-dsh-plugin`,
    );
  }
...
`;
  ...
  const rootPkgJson = {
    ...
    homepage: 'https://github.com/alibaba/anolisa/tree/main/providers/tokenless',
