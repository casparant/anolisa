...
build_cosh_ng() {
    ...
    if $DRY_RUN; then
        ...
        for bin in cosh-audit cosh-core cosh-gateway cosh-shell; do
...
install_cosh_ng() {
    ...
    ok "cosh-ng installed to ${INSTALL_BIN_DIR}/{cosh-audit,cosh-core,cosh-gateway,cosh-shell}"
...
uninstall_cosh_ng() {
    ...
    # binary was retired.
    for bin in cosh-audit cosh-cli cosh-core cosh-gateway cosh-shell; do
        if $DRY_RUN; then
